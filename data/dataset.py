...
class COCO_KD(PairedDataset):
    def __init__(self, image_field, text_field, img_root, ann_root, id_root=None, use_restval=False,
        ...
        roots['train'] = {
            ...
            'cap': os.path.join(ann_root, 'captions_train2014_kd_3.json')
        }
        roots['val'] = {
            'img': img_root,
            'cap': os.path.join(ann_root, 'captions_val5k.json')
        }
        roots['test'] = {
            'img': img_root,
            'cap': os.path.join(ann_root, 'captions_test5k.json')
        }
        roots['trainrestval'] = {
        ...
        super(COCO_KD, self).__init__(examples, {'image': image_field, 'text': text_field})
